// Tipos para el módulo Business Admin
...
// Helper para obtener clase CSS según color
export function getColorClass(color: EstadoReservaColor): string {
  switch (color) {
    case EstadoReservaColor.ROJO:
      return 'bg-danger text-white';
    case EstadoReservaColor.AMARILLO:
      return 'bg-warning text-dark';
    case EstadoReservaColor.NARANJA:
