...
export default function EventosDetailPage() {
    ...
    if (loading) {
        return <div className="container"><h1 className="text-center my-4">Cargando...</h1></div>;
    }

    if (!evento) return <p className="container text-center my-4">Evento no encontrado</p>;
    ...
    return (
        <div className="container">
            ...
            <div className="my-4">
                <h4>Fechas</h4>
                <p>{evento.fechaInicio} {evento.fechaFin ? `- ${evento.fechaFin}` : ''}</p>
            </div>
