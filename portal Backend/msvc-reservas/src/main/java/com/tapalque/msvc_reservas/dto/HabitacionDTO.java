...
public class HabitacionDTO {
    ...
    public BigDecimal getPrecioUnaPersona() { return precioUnaPersona; }
    public void setPrecioUnaPersona(BigDecimal precioUnaPersona) { this.precioUnaPersona = precioUnaPersona; }
